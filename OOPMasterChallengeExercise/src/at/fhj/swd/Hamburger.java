...
public class Hamburger {
    ...
    public Hamburger(String name, String meat, double basicPrice,
    ...
    public double itemizeHamburger(){
        double hamburgerPrice = this.basicPrice;
        System.out.println(this.name + " hamburger" + " on a " +
        this.breadRollType + " roll " + " with " + this.meat + ", price is " + this.basicPrice);
